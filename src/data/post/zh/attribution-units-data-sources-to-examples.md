---
title: '归因单位：从数据源到单个样本'
publishDate: 2026-08-23
excerpt: '为什么 attribution unit 很关键：数据源、数据组、文档、样本和 token 层面的归因回答的是不同研究问题，也支持不同证据强度。'
...
translationHref: '/attribution-units-data-sources-to-examples'
...
<div class="my-8 rounded-2xl border border-violet-200 bg-violet-50 p-5 dark:border-violet-900 dark:bg-violet-950/40">
  ...
  <p class="text-lg font-semibold text-slate-900 dark:text-white">归因单位不是小技术细节，而是决定研究结论的核心。数据源级、文档级和样本级结论不能互相替代。</p>
</div>
